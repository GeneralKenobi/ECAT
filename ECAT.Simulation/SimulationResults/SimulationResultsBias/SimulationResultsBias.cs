...
namespace ECAT.Simulation
{
	...
	public partial class SimulationResultsBias : ISimulationResults
	{
		...
		public void LoadNewData(IEnumerable<INode> nodes, IEnumerable<KeyValuePair<int, IPhasorDomainSignal>> vsCurrents)
		{
			...
			_Nodes.Insert(0, new Node() { Index = SimulationManager.GroundNodeIndex });
		}
		...
		/// <param name="nodeIndex"></param>
		/// <returns></returns>
		public ISignalInformation GetVoltageDropOrZero(int nodeIndex) =>
		GetVoltageDropOrZero(SimulationManager.GroundNodeIndex, nodeIndex);				
