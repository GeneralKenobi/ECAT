...
namespace ECAT.Core
{
	...
	/// <see cref="Initialization.Initialize(System.Collections.Generic.IEnumerable{Type})"/>.
	/// Remark: types passed to <see cref="Initialization.Initialize(System.Collections.Generic.IEnumerable{Type})"/> are not
